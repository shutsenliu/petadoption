...
@section('content')
  ...
  <nav class="position-relative">
    <ul class="pagination pagination-sm1 justify-content-center py-3">
      ...
      <li class="page-item disabled1"><a class="page-link1" href="/index/educatehowtohelp"><span>&raquo;</span></a></li>
      <a class="page-link1 position-absolute bottom-1 end-0" href="/index/educatehowtohelp"><span>幫助浪浪 &raquo;</span></a></li> 
    </ul>
