...
@section('content')
    ...
    <div class="container my-5 position-relative" style="width: 60rem ">
        ...
        <div class="row my-5">
            <div class="col-md-4  text-center">
                <a href="/index/educateadoptaway" target="_blank">
                    <img class="my-3" src="/layout/img/logo_icon.PNG" alt="領養浪浪"
        ...
        <a class="page-link1 position-absolute bottom-0 end-0" href="/index/educateadoptaway"><span>領養途徑 &raquo;</span></a>
        </li>
    </div>
