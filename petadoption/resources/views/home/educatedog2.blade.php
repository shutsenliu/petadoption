...
@section('content')
    ...
    <div class="container mt-5" style="width: 40rem;height: 47rem;">
        ...
        <ol>
            ...
            <li class="my-3">
                營養且合適的食物：有乾糧和濕食，如果發現狗狗的飲食營養不均衡，每天在點心時間餵狗狗生食或熟食。只要餵一些濕食，都比完全沒餵還要好得多。另一個方法是一週餵2—4次濕食，或是一週內，一半時間吃乾糧，另一半吃濕食。在主人能力可負擔的範圍內，給狗狗最佳的食物。
            </li>
            ...
            <li class="my-3">適度的運動可以促進狗狗的血液循環、幫助消化，散步的同時適度的曬太陽也能夠活絡骨骼、強健肌肉。但是，過度的運動，像是摩托車遛狗、爬高階樓梯、長時間跑步等，都會對毛孩的心臟及
                關節造成極大的負擔！以年輕的狗狗來說，如果劇烈運動過多，年紀大的時候容易出現兩種狀況：一為脊椎提早老化、二為心肺功能提早老化。而大約 4 歲以上的中年狗狗，如果強迫他持續以時速 12-15
                公里以上跑步，長期下來心臟容易提早老化。</li>
