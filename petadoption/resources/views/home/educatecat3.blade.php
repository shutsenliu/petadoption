...
@section('content')
  ...
  <div class="container my-5" style="width: 40rem;height: 48rem;">
    ...
    <ol>
      ...
      <li class="my-3">不親人：通常只要飼主付出足夠的關愛及時間照顧、陪伴貓咪，大多貓咪都會親近飼主，甚至黏人撒嬌。但有些貓咪會因為本身的個性，或曾經受過人類傷害等原因，而始終害怕人類，或即使不害怕，但也很少主動親近人或不喜歡讓人抱，所以如果你喜歡熱情黏人的寵物，可以優先考慮養狗，或是養貓前先跟他相處，了解他的個性。</li>
      <li class="my-3">抓家具：貓咪會磨爪以去除老廢指甲，所以飼主必須準備貓抓板。但有些貓即使有貓抓板也會抓其他家具，因此如果完全不能接受，就要考慮一下是否要養貓。</li>
      <li class="my-3">晚上不睡覺：貓咪是夜行性動物，因此半夜跑跳、玩耍或吵鬧是正常的。有些飼主能透過訓練或一些方式讓貓咪跟著飼主的作息生活，但不是每個人都能成功，所以必須把這一點也考慮進去。</li>
      <li class="my-3">亂尿尿：貓咪亂尿尿的原因很多，可說是養貓常見的困擾，飼主也必須全盤了解貓咪的習性，才能避免／改正這種狀況。</li>
      <li class="my-3">生病：貓咪沒有健保，即使是平常的皮膚病、感冒等等的小病，一次也要幾百塊，複診就要上千塊，更不用說其他較嚴重的疾病了。因此如果不願意在貓咪身上花那麼多錢，或無法在平時就慢慢存下醫療基金，養貓前可能就要考慮一下。</li>
  ...
  <nav>
    <ul class="pagination pagination-sm1 justify-content-center py-3">
      ...
      <li class="page-item disabled1"><a class="page-link1" href="/index/educatecat3"><span>&raquo;</span></a></li>
    </ul>
  </nav>
@endsection