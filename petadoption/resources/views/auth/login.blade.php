                    ...
                    <form action="/index/login" method="post">
                        ...
                        <div class="form-row">
                            <div class="col-auto">
                                ...
                                <input type="text" name="email" class="form-control mb-2" id="inlineFormInput"
                                    placeholder="Email 帳號">
                            </div>
                            <div class="col-auto mb-3">
                                <label for="inlineFormInputGroup">密碼</label>
                                <input type="password" name="pwd" class="form-control" id="inlineFormInputGroup"
                                    placeholder="密碼">
                            </div>
                        </div>
                        <div class="col-auto mb-3">
                        ...
                        <div class="col-auto  text-center mb-4">
                            ...
                            <div class="col-auto  text-center ">
                                <a href="/index/forgetpwdsendemail">忘記密碼</a>
                            </div>
                            <div class="text-center mt-3">還沒註冊嗎?<a href="/index/registersendemail">去註冊</a></div>
                        </div>
                    </form>
                </div>
            </div>
